...
public class ProveedorResourceIntTest {
    ...
    public void createProveedor() throws Exception {
        ...
        assertThat(testProveedor.getCiudad()).isEqualTo(DEFAULT_CIUDAD);
        assertThat(testProveedor.getDepartamento()).isEqualTo(DEFAULT_DEPARTAMENTO);
    }
    ...
    public void updateProveedor() throws Exception {
        ...
        assertThat(testProveedor.getCiudad()).isEqualTo(UPDATED_CIUDAD);
        assertThat(testProveedor.getDepartamento()).isEqualTo(UPDATED_DEPARTAMENTO);
    }
