...
public class ProductoResourceIntTest {
    ...
    private static final Long DEFAULT_PRECIO_COSTO = 1L;
    private static final Long UPDATED_PRECIO_COSTO = 2L;

    private static final Long DEFAULT_PRECIO_VENTA = 1L;
    private static final Long UPDATED_PRECIO_VENTA = 2L;

    private static final Long DEFAULT_EXISTENCIA = 1L;
    private static final Long UPDATED_EXISTENCIA = 2L;
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto()
            ...
            .precioCosto(DEFAULT_PRECIO_COSTO)
    ...
    public void createProducto() throws Exception {
        ...
        assertThat(testProducto.getPrecioCosto()).isEqualTo(DEFAULT_PRECIO_COSTO);
        assertThat(testProducto.getPrecioVenta()).isEqualTo(DEFAULT_PRECIO_VENTA);
        assertThat(testProducto.getExistencia()).isEqualTo(DEFAULT_EXISTENCIA);
    }
    ...
    public void getAllProductos() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].precioCosto").value(hasItem(DEFAULT_PRECIO_COSTO.intValue())))
            .andExpect(jsonPath("$.[*].precioVenta").value(hasItem(DEFAULT_PRECIO_VENTA.intValue())))
            .andExpect(jsonPath("$.[*].existencia").value(hasItem(DEFAULT_EXISTENCIA.intValue())));
    }
    ...
    public void getProducto() throws Exception {
        ...
        restProductoMockMvc.perform(get("/api/productos/{id}", producto.getId()))
            ...
            .andExpect(jsonPath("$.precioCosto").value(DEFAULT_PRECIO_COSTO.intValue()))
            .andExpect(jsonPath("$.precioVenta").value(DEFAULT_PRECIO_VENTA.intValue()))
            .andExpect(jsonPath("$.existencia").value(DEFAULT_EXISTENCIA.intValue()));
    }
    ...
    public void updateProducto() throws Exception {
        ...
        updatedProducto
            ...
            .precioCosto(UPDATED_PRECIO_COSTO)
        ...
        assertThat(testProducto.getPrecioCosto()).isEqualTo(UPDATED_PRECIO_COSTO);
        assertThat(testProducto.getPrecioVenta()).isEqualTo(UPDATED_PRECIO_VENTA);
        assertThat(testProducto.getExistencia()).isEqualTo(UPDATED_EXISTENCIA);
    }
